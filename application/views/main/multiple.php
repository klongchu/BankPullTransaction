<div class="content-w">
    ...
    <form action="<?=base_url('main/pickbank');?>" method="post">
    <div class="content-i">
        <div class="content-box">
            <div >
            <input type="submit" name="btn_find" value="ดููรายการบัญชีที่เลือก" class="btn btn-primary"  style="cursor: pointer;"/>
            <br />
            <br />
                <div class="row">
                    <?php
                    $i_bank = $data->id;
                    $s_seclect = array('*');
$s_conditions['where'] = array("i_bank <> 3");
                    $s_order_by = array('d_update' => 'desc');
                    ...
                    foreach ($bank_list_q as $bank_list) {
                        ...
                        <div class="col-sm-4">
                            <div class="element-box el-tablo" style="padding-right: 1px; ">
                                <input type="checkbox" name="i_bank_list[]" value="<?=$bank_list->id;?>" style="position: absolute;
    height: 25px;
    width: 25px;
    margin-left: -30px;
    margin-top: -20px;" id="i_bank_list<?=$bank_list->id;?>"/>
    <label for="i_bank_list<?=$bank_list->id;?>">
    ...
    <?php if($bank_list->i_bank != 7){ ?>
                                            <div class="user-role">xxx-x-x<?= $bank_no2; ?>-<?= $bank_no[3]; ?></div>
                                            <?php }else{ ?>
                                            <div class="user-role"><?= $data->s_name; ?> <?= $bank->s_name; ?></div>
                                            <?php } ?>
