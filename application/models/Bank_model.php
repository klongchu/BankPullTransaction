...
class Bank_model extends CI_Model {
    ...
    public function delete() {
        ...
        $bank_list = $this->db->where('id', $id)->get('tbl_bank_list')->row();
        $bank_main = $this->db->where('id', $bank_list->i_bank)->get('tbl_bank')->row();
...
//        $this->db->delete('updatebankdetailauto_'.$bank_name);
        return 1;
    }
